...
"use strict";
    ...
    function init(options) {
        ...
        sectionsContainer.append('<div id="page-ajax-loaded" class="page-ajax-loaded"></div>');
        ajaxLoader();
    }
    ...
    function ajaxLoader() {
        ...
        function showContent() {
            ajaxLoadedContent.removeClass('fadeIn closed');
            ajaxLoadedContent.show();
        }

        function hideContent() {
            $('#page-ajax-loaded').addClass('fadeIn closed');
            setTimeout(function(){
